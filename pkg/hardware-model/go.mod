module github.com/lf-edge/eve/pkg/hardware-model
...
require (
	github.com/lf-edge/eve/pkg/pillar v0.0.0
	github.com/sirupsen/logrus v1.9.3
)

// Local development - replace with local pillar for development
// In production, this should use versioned dependencies
replace github.com/lf-edge/eve/pkg/pillar => ../pillar

require (
	github.com/StackExchange/wmi v0.0.0-20190523213315-cbe66965904d // indirect
	github.com/anatol/smart.go v0.0.0-20241126061019-f03d79b340d2 // indirect
